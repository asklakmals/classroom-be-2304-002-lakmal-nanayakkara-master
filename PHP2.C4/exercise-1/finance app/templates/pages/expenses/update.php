...
<div class="row mt-5">
    <div class="col-12">
        <h1>Update an expense <?= $expense["name"] ?></h1>
    </div>
</div>
<div class="row my-5">
    <div class="col-12">
        <form action="/expenses/update/id/<?= $expense["expense_id"] ?>" method="post">
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="<?= $expense["name"] ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($expense["periodicity"] == 0) {
                            echo "checked";
                        } ?> type="radio" name="periodicity" id="periodicity1" value="0" >
                        <label class="form-check-label" for="periodicity1">
                            No
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($expense["periodicity"] == 1) {
                            echo "checked";
                        } ?> type="radio" name="periodicity" id="periodicity2" value="1">
                        <label class="form-check-label" for="periodicity2">
                            Fixed
                        </label>
                    </div>
                    <div class="form-check disabled">
                        <input class="form-check-input" <?php if ($expense["periodicity"] == 2) {
                            echo "checked";
                        } ?> type="radio" name="periodicity" id="periodicity3" value="2">
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($expense["status"] == 0) {
                            echo "checked";
                        } ?> type="radio" name="status" id="status1" value="0" >
                        <label class="form-check-label" for="status1">
                            Unreceived
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($expense["status"] == 1) {
                            echo "checked";
                        } ?> type="radio" name="status" id="status2" value="1">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="user-email" name="user-email" value="<?= $expense[
                        "email"
                    ] ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="expense-update">Update</button>
                </div>
            </div>
        </form>
    </div>
