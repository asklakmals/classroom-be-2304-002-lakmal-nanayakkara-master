...
<div class="row mt-5">
    <div class="col-12">
        <h1>Update an income <?= $income["name"] ?></h1>
    </div>
</div>
<div class="row my-5">
    <div class="col-12">
        <form action="/incomes/update/id/<?= $income["income_id"] ?>" method="post">
                ...
                <div class="col-sm-10">
                    <select name="categories" id="categories" class="form-control">
                        ...
                        <?php foreach ($categories as $category) {
                            if ($income["category_id"] == $category["category_id"]) { ?>
                ...
                <div class="col-sm-10">
                    <select name="accounts" id="accounts" class="form-control">
                        ...
                        <?php foreach ($accounts as $account) {
                            if ($income["account_id"] == $account["account_id"]) { ?>
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($income["periodicity"] == 0) {
                            echo "checked";
                    ...
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($income["periodicity"] == 1) {
                            echo "checked";
                    ...
                    <div class="form-check disabled">
                        <input class="form-check-input" <?php if ($income["periodicity"] == 2) {
                            echo "checked";
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($income["status"] == 0) {
                            echo "checked";
                    ...
                    <div class="form-check">
                        <input class="form-check-input" <?php if ($income["status"] == 1) {
                            echo "checked";
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="user-email" name="user-email" value="<?= $income[
                        "email"
                    ] ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="income-create">Update</button>
                </div>
            </div>
        </form>
    </div>
