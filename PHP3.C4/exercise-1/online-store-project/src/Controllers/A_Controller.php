...
abstract class A_Controller implements I_Controller
{
    ...
    abstract protected function indexAction(): void; //GET

    abstract protected function editAction(): void; //POST

    abstract protected function deleteAction(): void; //GET

    abstract protected function addAction(): void; //POST
