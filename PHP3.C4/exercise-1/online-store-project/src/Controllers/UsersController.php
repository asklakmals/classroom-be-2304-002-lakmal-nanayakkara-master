...
class UsersController extends A_Controller
{
    ...
    private function validateAndAssignUserData(): array
    {
        $userData = [];
        if (
            $userData[Users::DB_TABLE_FIELD_EMAIL] = filter_var(
                $_POST[Users::DB_TABLE_FIELD_EMAIL],
            ...
            $userData[Users::DB_TABLE_FIELD_PASSWORD] = password_hash(
                $userData[Users::DB_TABLE_FIELD_PASSWORD],
                PASSWORD_DEFAULT
            );
        }
